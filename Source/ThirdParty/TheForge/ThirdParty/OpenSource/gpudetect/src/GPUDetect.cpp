...
GPUDetect::IntelGraphicsGeneration /*GPUDetect:: rbfx*/GetIntelGraphicsGeneration( INTEL_GPU_ARCHITECTURE architecture )
{
	switch( architecture )
	{
...
void /*GPUDetect:: rbfx*/GetIntelGraphicsGenerationAsCString( const IntelGraphicsGeneration generation, char* const outBuffer, size_t outBufferSize )
{
